...
main_buttons = [[
        ...
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/aayeinchat'),
        InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/aayein17')
        ],[
...
async def restart(client, message):
    msg = await message.reply_text(
        text="<i>__If you liked my service❤__.\n\nConsider and make a donation to support me 😊\n\n\nUPI ID - `pay-to-bhavdikartik@fam`</i>"
        )
